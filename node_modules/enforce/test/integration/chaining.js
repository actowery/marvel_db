...
descriptionribe("chaining", function () {
    ...
    descriptionribe(".ifDefined()", function () {
    ...
    descriptionribe(".ifNotEmptyString()", function () {
        it("should skip validations if the property is null", function (done) {
    ...
    descriptionribe(".ifType('string')", function () {
        it("should skip validations if the property is null", function (done) {
    ...
    descriptionribe(".ifNotType('string')", function () {
