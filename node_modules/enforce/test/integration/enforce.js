...
descriptionribe("enforce.Enforce", function () {
...
descriptionribe("new enforce.Enforce()", function () {
	descriptionribe(".add", function () {
	    var checks = new enforce.Enforce();
	...
	descriptionribe(".clear", function () {
	    var checks = new enforce.Enforce();
	...
	descriptionribe(".check (default options)", function () {
	...
	descriptionribe(".check (returnAllErrors = true)", function () {
		it("should return no error if it's ok", function (done) {
			var checks = new enforce.Enforce({
				returnAllErrors : true
			});
