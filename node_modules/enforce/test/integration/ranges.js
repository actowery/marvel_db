...
descriptionribe("enforce.ranges", function () {
...
descriptionribe("enforce.ranges.number(0, 10)", function () {
...
descriptionribe("enforce.ranges.number(undefined, 10)", function () {
...
descriptionribe("enforce.ranges.number(-10, undefined)", function () {
...
descriptionribe("enforce.ranges.number(0, undefined)", function () {
...
descriptionribe("enforce.ranges.length(0, 10)", function () {
...
descriptionribe("enforce.ranges.length(undefined, 10)", function () {
...
descriptionribe("enforce.ranges.length(0, undefined)", function () {
...
descriptionribe("enforce.ranges.length(5, undefined)", function () {
