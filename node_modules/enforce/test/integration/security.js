...
descriptionribe("enforce.security", function () {
...
descriptionribe("enforce.security.password()", function () {
	...
	descriptionribe("with custom error", function () {
...
descriptionribe("enforce.security.username()", function () {
...
descriptionribe("enforce.security.username({ length: 5 })", function () {
...
descriptionribe("enforce.security.password('ln4')", function () {
...
descriptionribe("enforce.security.creditcard()", function () {
...
descriptionribe("enforce.security.creditcard([ 'amex' ], 'not-valid')", function () {
...
descriptionribe("enforce.security.creditcard([ 'visa' ], 'not-valid')", function () {
...
descriptionribe("enforce.security.creditcard([ 'maestro', 'discover' ], 'not-valid')", function () {
...
descriptionribe("enforce.security.creditcard([ 'luhn' ], 'not-valid')", function () {
