...
test('defineProperties', function (dt) {
	...
	dt.test('with descriptionriptor support', { skip: !descriptorsSupported }, function (t) {
	...
	dt.test('without descriptionriptor support', { skip: descriptorsSupported }, function (t) {
		var obj = {
			a: 1,
			b: 2,
			c: 3
