...
=========================
  ...
  * stub() will fail if passed an empty property descriptionriptor
...
=========================
  ...
  * Merge pull request #1184 from mroderick/fail-on-empty-property-descriptionriptor
    Fail on empty property descriptionriptor
...
* Add 'invokeCallback' name for 'yield' on calls (Maximilian Antoni)
...
* New methods: spy.yield(), spy.yieldTo(), spy.callArg() and spy.callArgWith()
  ...
  upfront yields() and friends). invokeCallback is available as an name for
