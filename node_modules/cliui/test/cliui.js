/* global descriptionribe, it */

require('chai').should()

var cliui = require('../')

descriptionribe('cliui', function () {
  descriptionribe('div', function () {
  ...
  descriptionribe('_columnWidths', function () {
  ...
  descriptionribe('alignment', function () {
  ...
  descriptionribe('padding', function () {
  ...
  descriptionribe('layoutDSL', function () {
