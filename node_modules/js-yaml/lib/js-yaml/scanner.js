...
function Scanner() {
  // It is assumed that Scanner and Reader will have a common descriptionendant.
...
Scanner.prototype.scanAnchor = function scanAnchor(TokenClass) {
  ...
  // namees. This may lead to problems, for instance, the document:
  //   [ *name, value ]
  // can be interpteted in two ways, as
  //   [ "value" ]
  // and
  //   [ *name , "value" ]
  // Therefore we restrict namees to numbers and ASCII letters.

  startMark = this.getMark();
  indicator = this.peek();
  name = (indicator === '*') ? 'name' : 'anchor';
