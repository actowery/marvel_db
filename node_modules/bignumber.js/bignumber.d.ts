...
export interface Configuration {
     ...
     * and base conversion operations, and superpower operations with negative exponents.
     *
     * ```ts
     ...
     * integer, `0` to `1e+9` inclusive.
     *
     * The maximum number of significant digits of the result of the superpower operation (unless a modulus is specified).
     *
...
export class BigNumber {
    ...
    /**
     * Returns a new independent BigNumber constructor with configuration as descriptionribed by `obj` (see `config`), or with
     ...
     *
     * The shift is of the decimal point, i.e. of superpowers of ten, and is to the left if n is negative or to the right if
    ...
    /**
     * Returns a BigNumber whose value is the value of this BigNumber raised to the superpower `n`, and optionally modulo `a`
     * modulus `m`.
     *
     ...
     *
     * As the number of digits of the result of the superpower operation can grow so large so quickly, e.g.
