...
descriptionribe("SQL.CREATE_TABLE", function () {
...
descriptionribe("SQL.DROP_TABLE", function () {
...
descriptionribe("SQL.ALTER_TABLE_ADD_COLUMN", function () {
...
descriptionribe("SQL.ALTER_TABLE_RENAME_COLUMN", function () {
	it("should be correct", function (done) {
...
descriptionribe("SQL.ALTER_TABLE_MODIFY_COLUMN", function () {
...
descriptionribe("SQL.ALTER_TABLE_DROP_COLUMN", function () {
	it("should return an ALTER TABLE", function (done) {
...
descriptionribe("SQL.CREATE_INDEX", function () {
...
descriptionribe("SQL.DROP_INDEX", function () {
