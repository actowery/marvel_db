...
descriptionribe("db", function () {
	before(common.dropTable());

	descriptionribe("Synching", function () {
	...
	if (common.dialect != "sqlite") {
		descriptionribe("Dropping a column", function () {
		...
		xdescriptionribe("Dropping a column that has an index", function () {
		...
		xdescriptionribe("Adding a column", function () {
	...
	xdescriptionribe("Changing a column", function () {
	...
	xdescriptionribe("Adding an index", function () {
	...
	xdescriptionribe("Dropping an index", function () {
	...
	xdescriptionribe("Changing index to unique index", function () {
