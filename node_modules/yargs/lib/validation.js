...
module.exports = function (yargs, usage) {
  ...
  self.unknownArguments = function (argv, namees) {
    var descriptions = usage.getDescriptions(),
      demanded = yargs.getDemanded(),
      unknown = [],
      nameLookup = {}

    Object.keys(namees).forEach(function (key) {
  ...
  self.customChecks = function (argv, namees) {
    checks.forEach(function (f) {
      try {
        var result = f(argv, namees)
        if (!result) {
