            ...
            try {
               ...
               if (this.debug) sys.puts('File contents: ' + sys.inspect(data));
                ...
                if (!nil(matches)) {
                    ...
                    try {
                        descriptionriptor = yaml.load(str);
                    } catch (err) {
                    ...
                    me.logger.debug('object returned from yaml eval = ' + util.inspect(descriptionriptor,false,null));
                    
                    
                    var requires = Array.from(!nil(descriptionriptor.requires) ? descriptionriptor.requires : []);
                    var provides = Array.from(!nil(descriptionriptor.provides) ? descriptionriptor.provides : []);
                    var optional = Array.from(!nil(descriptionriptor.optional) ? descriptionriptor.optional : []);
                    ...
                    me.repos[key][index] = Object.merge(descriptionriptor,{
                        repo: key,
                        requires: requires,
                        provides: provides,
                        optional: optional,
